...
incentives. Many of today's economic challenges can be traced back to incentive systems that would benefit from thoughtful redesign.

Economic systems like capitalism are human creations that can be refined and improved. By designing thoughtful incentives, we can create more sustainable systems that benefit a broader segment of society.
...
While change can be gradual, increasing awareness about the importance of incentive design gives reason for optimism that we can move toward more balanced and sustainable housing systems over time.

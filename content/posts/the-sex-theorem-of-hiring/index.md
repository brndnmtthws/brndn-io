...
In practice, you tend to see three kinds of candidates:

### The SE (Skilled + Experienced)

These are your "10x engineers" (a term I use reluctantly). They've shipped hard things, watched systems break in ugly ways, and learned which shortcuts come back to bite you. They've seen systems fail in surprising ways, have built complex architectures that scale, and can spot potential issues before they become problems. An SE might be able to solve in an afternoon what would take a junior team a week, and they usually won't leave behind a bigger mess for six months from now.
...
Typically a younger person with natural talent—perhaps a recent graduate or even a dropout. They don't have much scar tissue yet, but they often know the newer tools cold and are still hungry enough to throw themselves at hard problems. For them, your job represents a significant opportunity for growth.

The best SXs are the ones who take feedback well and stop making the same mistake twice. They might have impressive GitHub repositories, contest wins, or side projects that demonstrate their raw talent. They're often worth taking a chance on, especially when paired with mentors who can help them develop.

### The EX (Experienced + inexpensive)

Potentially the most problematic hire. Their resume might be decorated with impressive company names and extensive years of service, but their actual contributions have been minimal. They know how to interview, how to survive big-company nonsense, and how to sound useful in meetings, but when it's time to actually build something difficult, they tend to disappear.
...
The optimal engineering team consists primarily of SEs, with some promising SXs for growth potential. That's the setup where the younger engineers actually learn good habits instead of cargo-culting whatever barely works. However, this approach requires a significant investment and commitment to competitive compensation.

Problems arise when organizations accumulate too many EXs, especially in leadership positions. Put enough EXs over SEs and everything starts turning into process theater: more meetings, more checklists, more status games, less useful work getting done. A heavy concentration of EXs and SXs often leads to technical debt, missed deadlines, and eventual product failure.
...
If you ignore this, you'll build the kind of engineering org that looks fine from the outside and quietly can't ship.

...
systems](https://pubmed.ncbi.nlm.nih.gov/20887675/).

I will confess, I spend too much time watching stock market gyrations. Most day-to-day ups and downs are random, and this has been demonstrated by numerous academics and finance professionals. The seminal work on this idea—the [Random Walk Hypothesis](https://www.jstor.org/stable/2351623)—was first articulated by economist Burton Malkiel in his 1973 book "A Random Walk Down Wall Street." Of course, if you pay too much attention to "the news," you'll start to believe there's always a cause or reason for why stocks go up or down, but in reality, the system is too complex to make these attributions with certainty.
...
It's helpful to remember: you don't always _need_ to find an explanation for everything. Humans are special in that our brains are pattern-matching algorithms on hyperdrive at all times, except perhaps while we sleep. This tendency, known as [apophenia](https://www.sciencedirect.com/science/article/abs/pii/S0010027714001462)—the tendency to perceive connections between unrelated phenomena—is deeply embedded in our cognitive architecture. We're always looking for symbolism, higher meaning, and causality, but most of our daily events are quite random outside of ordinary routines.

For example, if I'm on a morning walk and a neighbor who's usually friendly suddenly snubs me, I could either take offense or realize they're probably preoccupied with something else in _their_ life. I likely don't matter enough in their day for them to deliberately be rude to me, which is actually quite liberating.

It's easy to get annoyed about trivial interactions: maybe the barista made a mistake with your coffee order, or perhaps a package you ordered didn't arrive on time. We tend to let these random events frustrate us when they simply aren't worth our emotional energy.

A lot of random data is, I suspect, just a [Rorschach test](https://en.wikipedia.org/wiki/Rorschach_test)—we tend to see what we're primed to see. Market's up today? Must be the great news about \<thing\>! Market down today? Must be because \<company\> had a bad earnings report! There might be some truth to such interpretations, but the connection is often tenuous at best. Nassim Nicholas Taleb, in his book ["Fooled by Randomness"](https://www.penguinrandomhouse.com/books/176215/fooled-by-randomness-by-nassim-nicholas-taleb/), offers compelling arguments about how we systematically overestimate causality and underestimate chance in our daily lives.
